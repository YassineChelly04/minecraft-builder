"""
Audited valid-block set for Minecraft Java Edition 1.21 (the base layer of the
version registry). Moved verbatim out of the old blocks.py so blocks.py can
become a thin shim over knowledge.blocks_registry.resolve(TARGET_MC_VERSION).

Only solid / reliably placeable blocks. Gravity blocks are present but agents are
told not to use them in walls.
"""
...
BASE_1_21 = {
    ...
    "minecraft:petrified_oak_slab", "minecraft:brick_slab",
    ...
    "minecraft:birch_fence_gate", "minecraft:dark_oak_fence_gate",
    ...
    "minecraft:jack_o_lantern", "minecraft:torch", "minecraft:soul_torch",
    "minecraft:end_rod",
    ...
    "minecraft:note_block", "minecraft:bell", "minecraft:flower_pot",
    ...
    "minecraft:water", "minecraft:moss_block", "minecraft:glow_lichen",
}
